...
const Projects = () => {
  ...
  return (
    ...
    viewport={{ once: true }}
    className='continer mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'> 
        ...
        <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Spaces, Buildig Legacies-Explore Our Portfolio </p>
    
        {/* Slider buttons */}
        <div className=' flex justify-end items-center mb-8' >
            <button onClick={PrevProject} className='p-3 mr-2 bg-gray-200 rounded'>
                <img src={assets.left_arrow} alt="Previous" />
            </button>
            <button onClick={nextProject} className='p-3 mr-2 bg-gray-200 rounded'>
